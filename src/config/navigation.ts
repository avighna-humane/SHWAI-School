  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "Route",
        roles: ["student", "teacher", "staff", "principal", "admin", "owner"],
        plan: "professional",
        badge: "AI",
        description: "Persisted concepts, prerequisite gaps, practice and revision paths",
      },
      {
        label: "Classroom assistant",
        path: "/app/ai/classroom-assistant",
        icon: "School2",
        roles: ["teacher", "principal", "admin", "owner"],
        plan: "professional",
        badge: "AI",
        description: "Approved-context explanations, examples and differentiation suggestions",
      },
      {
        ...
        plan: "enterprise",
        badge: "AI",
        description: "Source evidence, approval history, model metadata and school AI settings",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        plan: "enterprise",
        badge: "AI",
        description: "Insufficient-data safeguards, warnings, evaluation and human review",
      },
    ],
  },
  {
