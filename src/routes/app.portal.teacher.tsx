...
const PORTAL_CARDS = [
  {
    ...
    label: "Notices",
    description:
      "View school notices and announcements from the principal. You can read all notices addressed to teachers.",
    path: "/app/notices",
  ...
  },
  {
    ...
    description:
      "Generate reviewable homework, worksheets, quizzes, notes, flashcards and lesson resources.",
    path: "/app/ai/studio",
    primary: "Open AI Studio",
    badge: "AI" as const,
    highlight: true,
    note: "Teacher approval required before publishing",
  },
  {
    icon: "WandSparkles",
    label: "Teacher AI Assistant",
    description:
      "Draft lesson plans, differentiated assignments, translations, report comments and parent messages.",
  ...
  },
  {
    ...
    description:
      "Review, edit, publish and revisit AI-generated resources within your school workspace.",
          ...
          >
            ...
            {card.note && (
              <p className="mt-1.5 flex items-center gap-1 text-[11px] text-muted-foreground">
                <Icons.Eye className="size-3 shrink-0" />
                {card.note}
              </p>
            )}
