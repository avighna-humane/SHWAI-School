...
export const FEATURE_COMPARISON: ComparisonRow[] = [
  ...
  {
    group: "Administration",
    feature: "Classes, sections & academic years",
    starter: true,
    professional: true,
    enterprise: true,
  },
  {
    group: "Administration",
    feature: "Multi-campus operations",
    starter: false,
    professional: false,
    enterprise: true,
  },
  {
    ...
    enterprise: "Granular + audit",
  },
  {
    group: "Academics",
    feature: "Homework & assignments",
    starter: true,
    professional: true,
    enterprise: true,
  },
  {
    ...
    enterprise: "AI-assisted + advanced",
  },
  {
    group: "Academics",
    feature: "Exams & quizzes",
    starter: true,
  ...
  {
    group: "AI",
    feature: "AI student tutor with progressive hints",
    starter: false,
    professional: true,
    enterprise: true,
  },
  ...
  {
    group: "AI",
    feature: "AI provenance & evidence panel",
    starter: false,
  ...
  {
    group: "Intelligence",
    feature: "Concept & misconception intelligence",
    starter: false,
    professional: true,
    enterprise: true,
  },
  {
    group: "Intelligence",
    feature: "School analytics dashboard",
  ...
  {
    group: "Support",
    feature: "Intervention workflows",
    starter: false,
    professional: true,
    enterprise: true,
  },
  {
    group: "Support",
    feature: "Intervention experiment tracker",
    starter: false,
    professional: false,
    enterprise: true,
  },
  {
    group: "Support",
    feature: "Student context passport",
    starter: false,
    professional: false,
    enterprise: true,
  },
  ...
  {
    group: "Operations",
    feature: "Fees, scholarships & receipts",
    starter: false,
    professional: false,
    enterprise: true,
  },
  {
    group: "Operations",
    feature: "Transport & GPS tracking",
    starter: false,
    professional: false,
    enterprise: true,
  },
  {
    group: "Operations",
    feature: "Library, inventory & facilities",
  ...
  {
    group: "Planning",
    feature: "Teacher workload optimiser",
    starter: false,
  ...
  {
    group: "India-first",
    feature: "Offline attendance & marks entry",
    starter: false,
    professional: false,
    enterprise: true,
  },
  {
    group: "India-first",
    feature: "Regional-language parent messaging",
    starter: "SMS",
  ...
  {
    group: "Governance",
    feature: "Audit & data-access logs",
    starter: false,
    professional: "Core logs",
    enterprise: "Full logs",
  },
  {
    group: "Governance",
    feature: "Data retention & deletion workflows",
    starter: false,
    professional: false,
    enterprise: true,
  },
...
export const INVOICES: Invoice[] = [
  ...
  {
    id: "inv-3",
    number: "SHW/2025-26/0058",
    date: "01/10/2025",
    period: "Add-on licences (Oct 2025)",
    students: 108,
    ratePerStudent: 190,
    subtotal: 20520,
    gst: 3694,
