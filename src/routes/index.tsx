    ...
    <div className="w-full text-left rounded-2xl border border-border bg-[#f8fafc] p-4 sm:p-6 shadow-elevated">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-4 mb-5">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-[#334155] font-semibold text-sm tracking-tight select-none">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="bg-card rounded-xl border border-border p-5 flex flex-col justify-between shadow-sm transition-all duration-300 hover:shadow-md hover:border-primary/20 relative overflow-hidden">
                ...
                <div className="relative h-44 flex items-end justify-between border-b border-border/80 pb-2 mt-4 px-2">
                  ...
                  {[
                    ...
                    <div key={i} className="flex flex-col items-center gap-1 w-[14%] z-10">
                      <span className="text-[9px] font-bold text-[#0f172a] font-mono mb-0.5">
                        {b.pct}
                      </span>
                      <div
                      ...
                      />
                      <span className="text-[8px] text-[#64748b] font-mono mt-1 whitespace-nowrap">
                        {b.label}
                      </span>
                    </div>
                  ))}
                  <svg
                    className="absolute inset-0 h-44 w-full pointer-events-none"
                    viewBox="0 0 100 100"
                    preserveAspectRatio="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path
                      d="M 10 38 L 30 40 L 50 34 L 70 44 L 90 38"
                      stroke="#3b82f6"
                      strokeWidth="2.5"
                      strokeLinecap="round"
                  ...
                  {[10, 30, 50, 70, 90].map((l) => (
                    <div
                      key={l}
                      className="absolute bottom-[110px] -translate-x-1/2 translate-y-1/2 size-2 rounded-full bg-primary border border-white"
                      style={{ left: `${l}%` }}
                    />
                  ))}
                </div>
              ...
              <div className="mt-5 p-3 rounded-lg bg-[#eff6ff] border border-[#bfdbfe]/40 text-[#1e40af] text-[11px] flex items-start gap-2">
                ...
                <p>
                  Overall attendance is stable at <strong>94.2%</strong> this week.
                </p>
              </div>
            </div>
            ...
            <div className="bg-card rounded-xl border border-border p-5 flex flex-col shadow-sm transition-all duration-300 hover:shadow-md hover:border-primary/20">
              ...
              <div className="space-y-4">
                {[
                  {
                    initials: "EC",
                    bg: "bg-[#bfdbfe] text-blue-800 border-blue-200",
                    name: "Emily Chen",
                    grade: "Grade 10 • GPA 3.9",
                    subjects: "Math A | Sci A-",
                    pct: 96,
                    delay: "",
                  },
                  {
                    initials: "LW",
                    bg: "bg-[#fed7aa] text-orange-800 border-orange-200",
                    name: "Liam Wilson",
                    grade: "Grade 9 • GPA 3.4",
                    subjects: "Eng B+ | Hist B",
                    pct: 82,
                    delay: "delay-100",
                  },
                  {
                    initials: "SM",
                    bg: "bg-[#fbcfe8] text-pink-800 border-pink-200",
                    name: "Sophia Miller",
                    grade: "Grade 11 • GPA 4.0",
                    subjects: "Math A+ | Phys A+",
                    pct: 99,
                    delay: "delay-200",
                  },
                ].map((s, i) => (
                  <div
                    key={s.name}
                    className={`flex items-center justify-between ${i < 2 ? "border-b border-border/40 pb-3" : ""}`}
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`size-9 rounded-full ${s.bg} font-bold text-xs flex items-center justify-center border`}
                      >
                        {s.initials}
                      </div>
                      <div>
                    ...
                    <div className="text-right">
                      ...
                      <div className="h-1.5 w-20 rounded-full bg-[#f1f5f9] overflow-hidden mt-1.5">
                        <div
                          className={`h-full bg-[#0f52ba]/80 rounded-full animate-progress ${s.delay}`}
                          style={{ width: `${s.pct}%` }}
                        />
                      </div>
                    </div>
        ...
        {activeTab === "schedule" && (
          <div className="space-y-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[11px] font-mono bg-primary-soft text-primary px-2.5 py-1 rounded-md font-semibold">
                08:00 – 15:30
              </span>
            </div>
            <div className="space-y-2.5">
              {[
                ...
                >
                  ...
                  <div
                    className={`mt-1.5 w-0.5 h-8 rounded-full shrink-0 ${
                      c.status === "active"
                        ? "bg-primary"
                        : c.status === "break"
                          ? "bg-border"
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      <h4
                        className={`text-sm font-bold ${c.status === "break" ? "text-[#64748b]" : "text-[#0f172a]"}`}
                      >
                        {c.subject}
                      </h4>
                      {c.status === "active" && (
                        <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-primary text-white shrink-0">
                          In Progress
                        </span>
                      )}
                      {c.status === "done" && (
                        <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-success-soft text-success shrink-0">
                          Done
                        </span>
                      )}
                      {c.status === "upcoming" && (
                        <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-muted text-[#64748b] border border-border shrink-0">
                          Upcoming
                        </span>
                      )}
                    </div>
        ...
        {activeTab === "students" && (
          <div className="space-y-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[11px] font-semibold text-[#475569] bg-muted px-2.5 py-1 rounded-md border border-border">
                552 Students
              </span>
            </div>
            <div className="rounded-xl border border-border overflow-hidden bg-card">
              ...
              {[
                ...
                {
                  initials: "AM",
                  bg: "bg-[#d1fae5] text-emerald-800 border-emerald-200",
                  name: "Arjun Mehta",
                  cls: "Grade 10-B",
                  att: 74,
                  gpa: 3.1,
                ...
                {
                  initials: "MP",
                  bg: "bg-[#e0e7ff] text-indigo-800 border-indigo-200",
                  name: "Maya Patel",
                  cls: "Grade 9-A",
                  att: 91,
                  gpa: 3.6,
                ...
                {
                  initials: "JR",
                  bg: "bg-[#fef3c7] text-amber-800 border-amber-200",
                  name: "Jake Rivera",
                  cls: "Grade 11-B",
                  att: 88,
                  gpa: 3.3,
                ...
                <div
                  key={s.name}
                  className={`grid grid-cols-5 gap-3 items-center px-4 py-3 transition-colors hover:bg-muted/20 ${i < 5 ? "border-b border-border/60" : ""}`}
                >
                  <div className="col-span-2 flex items-center gap-2.5">
                    <div
                      className={`size-8 rounded-full ${s.bg} font-bold text-[11px] flex items-center justify-center border shrink-0`}
                    >
                      {s.initials}
                    </div>
                    <div>
                  ...
                  <div className="text-center">
                    <span
                      className={`text-xs font-bold font-mono ${s.att >= 90 ? "text-success" : s.att >= 80 ? "text-warning" : "text-danger"}`}
                    >
                      {s.att}%
                    </span>
                  </div>
                  ...
                  <div className="flex justify-center">
                    {s.ok ? (
                      <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-success-soft text-success">
                        On Track
                      </span>
                    ) : (
                      <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-warning-soft text-warning">
                        Alert
                      </span>
                    )}
                  </div>
              ...
              <div className="bg-card rounded-xl border border-border p-4">
                <div className="relative h-36 flex items-end justify-between border-b border-border/80 pb-2 px-1">
                  {[
                    ...
                    <div key={i} className="flex flex-col items-center gap-1 w-[14%] z-10">
                      <span className="text-[8px] font-bold text-[#0f172a] font-mono mb-0.5">
                        {b.pct}
                      </span>
                      <div
                        className={`w-full rounded-t-[3px] transition-colors animate-bar-scale ${b.hi ? "bg-[#0f52ba]/80 hover:bg-[#0f52ba]" : "bg-[#1e293b] hover:bg-[#0f172a]"}`}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={g.grade}
                    className="bg-card rounded-lg border border-border p-3 hover:border-primary/20 transition-colors"
                  >
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="h-1.5 w-full rounded-full bg-[#f1f5f9] overflow-hidden">
                      <div
                        className="h-full bg-[#0f52ba]/80 rounded-full animate-progress"
                        style={{ width: `${g.rate}%` }}
                      />
                    </div>
                  </div>
              ...
              <div className="p-3 rounded-lg bg-[#eff6ff] border border-[#bfdbfe]/40 text-[#1e40af] text-[11px] flex items-start gap-2">
                <Info className="size-4 shrink-0 mt-0.5 text-blue-500" />
                <p>
                  School-wide average is <strong>93.3%</strong> for Week 42.
                </p>
              </div>
            </div>
          </div>
                ...
                {[
                  ...
                  <div key={s.subject}>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <span
                        className={`text-xs font-bold font-mono ${s.avg >= 85 ? "text-success" : s.avg >= 80 ? "text-[#0f172a]" : "text-warning"}`}
                      >
                        {s.avg}%
                      </span>
                    </div>
                    <div className="h-1.5 w-full rounded-full bg-[#f1f5f9] overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${s.avg}%`,
                          background: s.avg >= 85 ? "#22c55e" : s.avg >= 80 ? "#0f52ba" : "#f59e0b",
                ...
                {[
                  ...
                  >
                    <div className="flex items-start justify-between gap-2 mb-2">
                      ...
                      <span className="text-[10px] font-bold font-mono text-[#0f172a] shrink-0">
                        {a.submitted}/{a.total}
                      </span>
                    </div>
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              {[
                ...
                <div
                  key={s.label}
                  className="bg-card rounded-xl border border-border p-4 flex items-center gap-3 hover:border-primary/20 transition-all duration-200 hover:shadow-sm"
                >
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="bg-card rounded-xl border border-border p-4">
                <h4 className="text-xs font-bold text-[#0f172a] mb-3 flex items-center gap-1.5">
                  <Calendar className="size-3.5 text-primary" /> Today's Classes
                </h4>
                <div className="space-y-2">
                  {[
                    ...
                    <div
                      key={c.time}
                      className={`flex items-center gap-3 p-2 rounded-lg text-xs transition-colors ${c.status === "active" ? "bg-primary-soft/30 border border-primary/20" : "hover:bg-muted/30"}`}
                    >
                      <span className="font-mono font-bold text-[10px] text-[#475569] w-10 shrink-0">
                        {c.time}
                      </span>
                      <div
                        className={`w-1 h-4 rounded-full shrink-0 ${c.status === "active" ? "bg-primary" : c.status === "done" ? "bg-success" : "bg-border"}`}
                      />
                      <div className="flex-1 min-w-0">
              ...
              <div className="bg-card rounded-xl border border-border p-4">
                <h4 className="text-xs font-bold text-[#0f172a] mb-3 flex items-center gap-1.5">
                  <GraduationCap className="size-3.5 text-primary" /> Student Highlights
                </h4>
                <div className="space-y-2">
                  {[
                    {
                    ...
                    },
                    {
                      ...
                      bg: "bg-[#d1fae5] text-emerald-800 border-emerald-200",
                      name: "Arjun Mehta",
                      detail: "Grade 10-B · 74% attendance",
                      ok: false,
                    },
                    {
                      initials: "SM",
                    ...
                    },
                    {
                      ...
                      bg: "bg-[#e0e7ff] text-indigo-800 border-indigo-200",
                      name: "Maya Patel",
                      detail: "Grade 9-A · 91% attendance",
                      ok: true,
                    },
                  ].map((s) => (
                    <div
                    ...
                    >
                      <div
                        className={`size-7 rounded-full ${s.bg} font-bold text-[10px] flex items-center justify-center border shrink-0`}
                      >
                        {s.initials}
                      </div>
                      <div className="flex-1 min-w-0">
                      ...
                      <span
                        className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full shrink-0 ${s.ok ? "bg-success-soft text-success" : "bg-warning-soft text-warning"}`}
                      >
                        {s.ok ? "✓" : "!"}
                      </span>
                    </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="bg-card rounded-xl border border-border p-4">
                <h4 className="text-xs font-bold text-[#0f172a] mb-3 flex items-center gap-1.5">
                  <NotebookPen className="size-3.5 text-primary" /> Pending Assignments
                </h4>
                <div className="space-y-2">
                  {[
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs font-semibold text-[#0f172a] truncate flex-1">
                          {a.title}
                        </span>
                        <span className="text-[10px] font-mono text-[#64748b] ml-2 shrink-0">
                          {a.submitted}/{a.total}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
              ...
              <div className="bg-card rounded-xl border border-border p-4">
                <h4 className="text-xs font-bold text-[#0f172a] mb-3 flex items-center gap-1.5">
                  <Info className="size-3.5 text-primary" /> School Alerts
                </h4>
                <div className="space-y-2">
                  {[
                    {
                      msg: "Arjun Mehta's attendance is below 75%. Early support recommended.",
                      type: "warning",
                    },
                    {
                      msg: "Physics Lab Report deadline is tomorrow. 3 submissions pending.",
                      type: "info",
                    },
  ...
  head: () => ({
    meta: [
      { title: "SHWAI — A Unified School Operating System" },
      {
        name: "description",
        content:
          "A platform unifying school administration, academic workflows, parent communication, and supportive AI learning tools.",
      },
      { property: "og:title", content: "SHWAI — A Unified School Operating System" },
      {
        property: "og:description",
        content:
          "Explore a unified platform for school operations, teacher support, and Socratic learning aids.",
      },
    ...
    <div className="min-h-screen bg-background text-foreground scroll-smooth">
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5">
        <div className="flex items-center gap-2.5">
          <img
            src="/logo-mark.png"
            alt="SHWAI Logo"
            className="size-9 object-contain transition-transform duration-500 hover:rotate-[10deg]"
          />
          <div>
        ...
        <nav className="flex items-center gap-2">
          ...
          <Button
            asChild
            size="sm"
            className="transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)]"
          >
      ...
      <section className="relative overflow-hidden border-y border-border bg-card/45">
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-16 text-center md:py-24">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base text-muted-foreground animate-fade-in-up delay-200">
            SHWAI is designed to bring academics, school operations, parent communication, and
            student learning support into a single, cohesive experience for your entire school
            community.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3 animate-fade-in-up delay-300">
            <Button
              asChild
              size="lg"
              className="transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 hover:shadow-[0_8px_16px_rgba(0,0,0,0.08)]"
            >
              <a href="#role-selection">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 hover:bg-accent/20"
            >
        ...
        <div className="grid gap-10 md:grid-cols-2 items-center">
          <div className="reveal">
            <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
              Connecting classrooms and administration
            </h2>
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
              When school workflows are isolated, communication breaks down and workloads increase.
              SHWAI is designed to bridge these gaps by connecting daily administrative duties with
              academic feedback.
            </p>
            <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
              This unified design helps school leaders coordinate enrollments, enables teachers to
              organize resources, assists parents in staying informed, and provides students with
              supportive learning pathways.
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 reveal-group">
            <div className="surface-panel p-5 bg-card/50 transition-all duration-300 hover:border-primary/20 hover:shadow-sm reveal">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Manage timetables, homework assignments, and exams in one place.
              </p>
            </div>
            <div className="surface-panel p-5 bg-card/50 transition-all duration-300 hover:border-primary/20 hover:shadow-sm reveal">
              <h3 className="text-sm font-bold">Structured Learning</h3>
              <p className="mt-1 text-xs text-muted-foreground">
                Support students inside and outside the classroom with step-by-step guidance.
              </p>
            </div>
            <div className="surface-panel p-5 bg-card/50 transition-all duration-300 hover:border-primary/20 hover:shadow-sm reveal">
              <h3 className="text-sm font-bold">School Insights</h3>
              <p className="mt-1 text-xs text-muted-foreground">
                Keep track of school attendance trends, progress, and workload metrics.
              </p>
            </div>
            <div className="surface-panel p-5 bg-card/50 transition-all duration-300 hover:border-primary/20 hover:shadow-sm reveal">
              <h3 className="text-sm font-bold">Clear Coordination</h3>
              <p className="mt-1 text-xs text-muted-foreground">
                Maintain open communication between parents, teachers, and coordinators.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 border-b border-border" id="role-selection">
        <div className="text-center mb-10 reveal">
          ...
          <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground">
            SHWAI is organized around distinct roles. Select a category below to explore the
            ...
            <>
              ...
              >
                <div>
                  ...
                  <p className="mt-2 text-xs text-muted-foreground leading-relaxed">
                    Access school-wide performance intelligence, monitor staff workloads, review
                    early academic alerts, and manage institutional governance.
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  <p className="mt-2 text-xs text-muted-foreground leading-relaxed">
                    Manage daily class attendance registers, plan lessons with AI assistance,
                    generate homework assignments, and log assessment grades.
                  </p>
                </div>
                <div className="mt-6 flex items-center gap-1.5 text-xs font-semibold text-primary border-t border-border/40 pt-4 w-full">
              ...
              >
                <div>
                  ...
                  <p className="mt-2 text-xs text-muted-foreground leading-relaxed">
                    Track cross-campus attendance statistics, view multi-campus fee collections,
                    review license usage, and monitor top-level operations.
                  </p>
                </div>
                <div className="mt-6 flex items-center gap-1.5 text-xs font-semibold text-primary border-t border-border/40 pt-4 w-full">
            ...
            <>
              ...
              >
                <div>
                  ...
                  <p className="mt-2 text-xs text-muted-foreground leading-relaxed">
                    View your daily class timetable schedule, check assigned homework deadlines, and
                    access socratic AI study tutor help.
                  </p>
                </div>
                <div className="mt-6 flex items-center gap-1.5 text-xs font-semibold text-primary border-t border-border/40 pt-4 w-full">
              ...
              >
                <div>
                  ...
                  <p className="mt-2 text-xs text-muted-foreground leading-relaxed">
                    Check your ward's daily attendance records, track active school bus routes,
                    review quarterly grade cards, and pay school fees.
                  </p>
                </div>
                <div className="mt-6 flex items-center gap-1.5 text-xs font-semibold text-primary border-t border-border/40 pt-4 w-full">
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 border-b border-border">
        <div className="grid gap-10 md:grid-cols-2 items-center">
          <div className="space-y-4 reveal">
            ...
            <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
              Supporting teaching prep and student learning
            </h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
              SHWAI includes features designed to assist teachers with resource preparation and
              scaffold student problem-solving outside the classroom.
            </p>
            <div className="space-y-3">
              <div className="flex gap-3">
                ...
                <p className="text-xs text-muted-foreground">
                  <strong className="text-foreground font-semibold">
                    Teacher Resource Helpers:
                  </strong>{" "}
                  Assist in generating lesson outlines, drafting homework worksheets, and creating
                  study guides, requiring final review and approval by the educator.
                </p>
              </div>
              <div className="flex gap-3">
                <CheckCircle2 className="size-4 text-success shrink-0 mt-0.5" />
                <p className="text-xs text-muted-foreground">
                  <strong className="text-foreground font-semibold">
                    Socratic Learning Support:
                  </strong>{" "}
                  Helps students with difficult assignments by offering structured, progressive
                  hints that prompt independent logical reasoning rather than giving direct answers.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 reveal">
            ...
            <div className="surface-panel p-5 bg-card/60 border border-border shadow-sm transition-all duration-300 hover:shadow-elevated">
              <p className="text-[10px] uppercase font-mono tracking-wider text-muted-foreground mb-3">
                Tutor Interaction
              </p>
              <div className="space-y-2">
                <div className="rounded bg-muted/30 p-2.5 text-xs text-[#334155] border border-border/40">
                  <span className="font-semibold text-[#0f172a]">Student:</span> I'm stuck on
                  finding the area of this sector.
                </div>
                <div className="rounded bg-primary-soft/50 p-2.5 text-xs text-[#0f172a] border border-primary-soft/80 animate-slide-up-fade delay-300">
                  <span className="font-semibold text-primary block mb-1">
                    Socratic Assistant (Hint 1 of 5):
                  </span>
                  <span className="text-[#334155] leading-relaxed">
                    What fraction of a full circle represents this sector's angle? How does that
                    angle compare to 360 degrees?
                  </span>
                </div>
              </div>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 border-b border-border">
        <div className="text-center mb-10 reveal">
          ...
          <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
            Designed to bring school workflows together
          </h2>
          <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground">
            See how information moves through SHWAI to connect administrators, teachers, students,
            and parents.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-4 reveal-group">
          <div className="relative p-5 border border-border rounded-xl bg-card transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-card group reveal">
            <div className="text-lg font-bold text-primary font-mono mb-2 transition-transform duration-300 group-hover:scale-110">
              01
            </div>
            <h4 className="text-sm font-bold">Operational Setup</h4>
            <p className="mt-1 text-xs text-muted-foreground">
              Administrators set up class cohorts, configure registers, and schedule timetables.
            </p>
          </div>
          <div className="relative p-5 border border-border rounded-xl bg-card transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-card group reveal">
            <div className="text-lg font-bold text-primary font-mono mb-2 transition-transform duration-300 group-hover:scale-110">
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Teachers mark attendance, assign homework, and record test grades in the gradebook.
            </p>
          </div>
          <div className="relative p-5 border border-border rounded-xl bg-card transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-card group reveal">
            <div className="text-lg font-bold text-primary font-mono mb-2 transition-transform duration-300 group-hover:scale-110">
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Students view timetables, submit homework, and receive learning hints.
            </p>
          </div>
          <div className="relative p-5 border border-border rounded-xl bg-card transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-card group reveal">
            <div className="text-lg font-bold text-primary font-mono mb-2 transition-transform duration-300 group-hover:scale-110">
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Teachers track grades and notice when a student requires targeted academic support.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-12 items-center">
            <div className="lg:col-span-5 reveal">
              ...
              <h2 className="mt-2 text-2xl font-bold tracking-tight sm:text-3xl">
                Visualizing student growth and needs
              </h2>
              <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
                SHWAI unifies operational records and academic milestones. It highlights key trends
                such as learning spikes, attendance indicators, and workload strain to let educators
                intervene early and effectively.
              </p>
              <div className="mt-6 flex flex-col gap-3">
                <div className="flex gap-3">
                  <div className="mt-0.5 grid size-5 shrink-0 place-items-center rounded-full bg-primary-soft text-[10px] font-bold text-primary">
                    1
                  </div>
                  <p className="text-xs text-muted-foreground">
                    <strong className="text-foreground font-semibold">Unified Records:</strong>{" "}
                    Track grades, attendance metrics, and homework completions across all classes in
                    one connected view.
                  </p>
                </div>
                <div className="flex gap-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    <strong className="text-foreground font-semibold">Teacher Verification:</strong>{" "}
                    Ensure human approval on high-stakes calls, keeping educators always in control
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-lg border border-border p-4 space-y-3">
                    <p className="text-[11px] font-bold text-muted-foreground">
                      Class Grade Distribution (Grade 9 — C)
                    </p>
                    <div className="space-y-2">
                      <div>
                      ...
                      <div>
                        ...
                        <div className="h-1.5 w-full rounded-full bg-muted overflow-hidden">
                          <div
                            className="h-full bg-success rounded-full animate-progress delay-100"
                            style={{ width: "87%" }}
                          />
                        </div>
                      </div>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 border-b border-border">
        <div className="text-center mb-12 reveal">
          ...
          <h2 className="text-2xl font-bold tracking-tight sm:text-3xl mt-1">
            SHWAI Product Roadmap
          </h2>
          <p className="mx-auto mt-2 max-w-2xl text-sm text-muted-foreground">
            A projection of how SHWAI is designed to evolve from core administration to intelligent
            support and long-term school intelligence.
          </p>
          <div className="mt-3 inline-flex items-center gap-1.5 rounded-md bg-muted px-2.5 py-1 text-[11px] font-mono text-muted-foreground border border-border/40">
            <Info className="size-3.5 text-primary" /> Roadmap projections are conceptual plans and
            do not represent currently active features.
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div
            className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-border/80 -translate-x-1/2 hidden md:block"
            aria-hidden
          />
            ...
            <div className="grid gap-6 md:grid-cols-2 md:items-start relative reveal">
              ...
              <div className="bg-card border border-border rounded-xl p-6 shadow-sm transition-all duration-300 hover:shadow-md hover:border-primary/20">
                <div className="flex items-center gap-2 mb-3">
                  <span className="rounded-full bg-[#f1f5f9] px-2.5 py-0.5 text-xs font-bold text-[#475569] border border-border">
                    V1–V2
                  </span>
                  <span className="rounded bg-[#eff6ff] px-2 py-0.5 text-[10px] font-semibold text-primary border border-blue-100">
                    Starter Core
                  </span>
                </div>
                <h3 className="text-base font-bold text-[#0f172a] mb-2">
                  Foundational School Workflows
                </h3>
                <p className="text-xs text-muted-foreground leading-relaxed mb-4">
                  Establishing the baseline operational register, schedule setup, and secure
                  dashboards for basic class tracking and parent coordination.
                </p>
                <div className="grid gap-2 sm:grid-cols-2 text-[11px] text-muted-foreground border-t border-[#e2e8f0]/60 pt-4">
                  <span className="flex items-center gap-1.5">
                    <Check className="size-3 text-primary shrink-0" /> Student & School Information
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Check className="size-3 text-primary shrink-0" /> Timetables & Scheduling
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Check className="size-3 text-primary shrink-0" /> Registers & Attendance
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Check className="size-3 text-primary shrink-0" /> Basic Portals & Reports
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Check className="size-3 text-primary shrink-0" /> Homework & Assessments
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Check className="size-3 text-primary shrink-0" /> Family Communication
                  </span>
                </div>
              </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 md:items-start relative reveal">
              ...
              <div className="bg-card border border-border rounded-xl p-6 shadow-sm transition-all duration-300 hover:shadow-md hover:border-primary/20">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="rounded bg-[#fdf2f8] px-2 py-0.5 text-[10px] font-semibold text-pink-700 border border-pink-100">
                    Professional
                  </span>
                </div>
                <h3 className="text-base font-bold text-[#0f172a] mb-2">
                  Intelligent Learning & Productivity
                </h3>
                <p className="text-xs text-muted-foreground leading-relaxed mb-4">
                  Introducing structured tutor scaffolding and content helpers designed to alleviate
                  teacher prep burdens and support individual concept acquisition.
                </p>
                <div className="grid gap-2 sm:grid-cols-2 text-[11px] text-muted-foreground border-t border-[#e2e8f0]/60 pt-4">
                  <span className="flex items-center gap-1.5">
                    <Sparkles className="size-3 text-pink-500 shrink-0" /> AI-Generated Content
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Sparkles className="size-3 text-pink-500 shrink-0" /> Weak-Concept Diagnosis
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Sparkles className="size-3 text-pink-500 shrink-0" /> Guided AI Student Support
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Sparkles className="size-3 text-pink-500 shrink-0" /> Student Intervention
                    Alerts
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Sparkles className="size-3 text-pink-500 shrink-0" /> Teacher Planning
                    Assistance
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Sparkles className="size-3 text-pink-500 shrink-0" /> Actionable Admin Insights
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 md:items-start relative reveal">
              ...
              <div className="bg-card border border-border rounded-xl p-6 shadow-sm transition-all duration-300 hover:shadow-md hover:border-primary/20">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="rounded bg-[#f0fdf4] px-2 py-0.5 text-[10px] font-semibold text-emerald-700 border border-emerald-100">
                    Enterprise AI
                  </span>
                </div>
                <h3 className="text-base font-bold text-[#0f172a] mb-2">
                  Advanced Operations & Institutional Intelligence
                </h3>
                <p className="text-xs text-muted-foreground leading-relaxed mb-4">
                  Expanding the scope to broad institutional coordination, offline availability,
                  compliance safeguards, and predictive data mapping for senior administration.
                </p>
                <div className="grid gap-2 sm:grid-cols-2 text-[11px] text-muted-foreground border-t border-[#e2e8f0]/60 pt-4">
                  <span className="flex items-center gap-1.5">
                    <Building className="size-3 text-emerald-600 shrink-0" /> Admissions, Fees &
                    Transport
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Building className="size-3 text-emerald-600 shrink-0" /> Offline & Multilingual
                    Support
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Building className="size-3 text-emerald-600 shrink-0" /> Decision & Resource
                    Simulation
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Building className="size-3 text-emerald-600 shrink-0" /> Strict AI Governance
                    Protocols
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Building className="size-3 text-emerald-600 shrink-0" /> Teacher Workload
                    Optimization
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Building className="size-3 text-emerald-600 shrink-0" /> Career & Curriculum
                    Insights
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Building className="size-3 text-emerald-600 shrink-0" /> Intervention
                    Effectiveness
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Building className="size-3 text-emerald-600 shrink-0" /> Future Risk & Resource
                    Planning
                  </span>
                </div>
              </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 reveal-group">
          <div className="p-4 border border-border rounded-lg bg-card/30 flex items-start gap-3 transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/30 hover:bg-card/75 reveal">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Tailored interfaces showing schedule summaries and notifications.
              </p>
            </div>
          </div>
          <div className="p-4 border border-border rounded-lg bg-card/30 flex items-start gap-3 transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/30 hover:bg-card/75 reveal">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Build assignments, check progress, and log gradebook marks.
              </p>
            </div>
          </div>
          <div className="p-4 border border-border rounded-lg bg-card/30 flex items-start gap-3 transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/30 hover:bg-card/75 reveal">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Daily attendance logs, cohort rosters, and timetable calendars.
              </p>
            </div>
          </div>
          <div className="p-4 border border-border rounded-lg bg-card/30 flex items-start gap-3 transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/30 hover:bg-card/75 reveal">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Structured user accounts and permissions for parent-teacher integrity.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-5">
          ...
          <div className="grid gap-4 lg:grid-cols-3 reveal-group">
            {PLANS.map((p) => (
              <article
                key={p.id}
                className="surface-panel flex flex-col p-6 justify-between bg-card transition-all duration-300 ease-out hover:-translate-y-1.5 hover:border-primary/40 hover:shadow-elevated reveal"
              >
                <div>
                ...
                <Button
                  ...
                  className="mt-6 w-full transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0"
                >
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 text-center reveal">
        <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
          Ready to simplify your school's workflows?
        </h2>
        <p className="mx-auto mt-4 max-w-xl text-sm text-muted-foreground leading-relaxed">
          Explore the SHWAI platform to see how we bring administration, class grading, student
          learning, and parent updates together.
        </p>
